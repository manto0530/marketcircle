...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { description: @detail.description, master_id: @detail.master_id } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { description: @detail.description, master_id: @detail.master_id } }
